...
When we held out 2010, we estimated the single highest intercept (good for the Democrats), along with the lowest correlations of USC results and prior STH races. Then, when we 2010 to those coefficients, a good year for Republicans, the model totall overshoots. Darn.
